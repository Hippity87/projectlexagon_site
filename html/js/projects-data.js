...
const projects = [
  ...
  },
  {
    ...
    category: "design",
    image: "/images/project_amp/amp_project04.jpg", // Placeholder path, update with your images
    viewProjectInfo: `
            ...
            <img src="/images/project_amp/amp_project01.jpg" alt="Amp & Cabinet" style="max-width: 100%;">
            <img src="/images/project_amp/amp_project02.jpg" alt="Amp & Cabinet" style="max-width: 100%;">
            ...
            <img src="/images/project_amp/amp_project03.jpg" alt="Amp & Cabinet" style="max-width: 100%;">
            <p>Also some electrical wiring and soldering was done to make amplifier connectivity possible, both parallel and series.</p>
            <img src="/images/project_amp/amp_project05.jpg" alt="Amp & Cabinet" style="max-width: 100%;">  
            <img src="/images/project_amp/amp_project06.jpg" alt="Amp & Cabinet" style="max-width: 100%;">
            <img src="/images/project_amp/amp_project04.jpg" alt="Amp & Cabinet" style="max-width: 100%;">
            `,
  },
